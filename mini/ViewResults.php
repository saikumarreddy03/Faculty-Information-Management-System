    ...
    if(!empty($_POST['faculty'])){
		...
		<table align="center" border=1>
				<tr>
					...
					<th align="center" width="150px">Students Appeared</th>
					<th align="center" width="150px">Students Passed</th>
					<th align="center" width="150px">Pass%</th>
        ...
        foreach($_POST['faculty'] as $selected){
            ...
            if($selected=="all")
            {
				$sqlCustomer = "SELECT * FROM results";
...
<body style="background-color:lightblue;">
	<link href="boot.css" rel="stylesheet" type="text/css" media="all">
	<legend align="left">Results</legend>
<body>
<table align="center" border=1>
<tr>
	<th align="center" width="150px">Faculty name</th>
...
$str="SELECT FacultyName,academicyear,subject,semister,branch,section,studapp,studpass,passper from  results";
$result=$conn->query($str);

...
<!-- Form Name -->
<legend>View assignment/formative</legend>
...
if(isset($_POST['submit'])){
    if(!empty($_POST['faculty'])){
		...
		<table align="center" border=1>
				...
				<th align="center" width="150px">Semester</th>
				<th align="center" width="150px">Subject</th>
				<th align="center" width="150px">Exam Type</th>
				<th align="center" width="150px">Scheduled Date</th>
				<th align="center" width="150px">Conducted Date</th>
				<th align="center" width="150px">Evaluation Date</th>
				<th align="center" width="150px">Submitted Date</th>
				</tr>
				<?php
        ...
        foreach($_POST['faculty'] as $selected){
            ...
            if($selected=="all")
            {
				$sqlCustomer = "SELECT * FROM assignment";
			...
			else
			{
					 ...
					 $sqlCustomer = "SELECT * FROM assignment where facultyname='$selected'";
				$aCustomer =mysql_query($sqlCustomer);
				?>

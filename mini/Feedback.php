...
function validateForm() {
    ...
    var d = document.forms["myform"]["feedback"].value;
    ...
    if (d== null || d=="")
    {
		alert("Enter feedback percentage");
        return false;
    }
    <?php
    /*if ( d>100.00)
    {
				...
				alert("Enter feedback percentage not more than 100.00");
				return false;
	}			
...
<form class="form-horizontal" onsubmit="return validateForm()" align="center" method="POST" action="StoreFeedback.php" name="myform">
<fieldset>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Feedback%</label>  
  <div class="col-md-4">
  <input id="textinput" name="feedback" pattern="[0-9]{1,3}\.[0-9]{2}" type="text" placeholder="Ex: 99.99" class="form-control input-md">

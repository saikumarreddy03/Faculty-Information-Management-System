...
<form class="form-horizontal" action="storelessonplan.php" method="POST" onsubmit="return validateForm()" name="myform">
<fieldset>
	<?php
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="semester" name="semester" onChange="getSubjects(this.value);" class="form-control">
		<option value="0">select an option</option>
		<?php
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">No. of clases planned</label>  
  <div class="col-md-4">
  <input id="1" name="classplan" type="text" placeholder="" pattern="[0-9]{1,3}" class="form-control input-md">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">No. of classes taken</label>  
  <div class="col-md-4">
  <input id="2" name="classtak" type="text" placeholder="" pattern="[0-9]{1,3}" class="form-control input-md">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Deviation%</label>  
  <div class="col-md-4">
  <input id="3" name="deviation" type="text" placeholder="" class="form-control input-md" readonly>

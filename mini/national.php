...
<form class="form-horizontal" action="storenational.php" method="POST" onsubmit="return validateForm()" name="myform">
<fieldset>
	<?php
...
<!-- Form Name -->
<legend>Paper publications in National Journals</legend>
<body>

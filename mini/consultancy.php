...
<form class="form-horizontal" action="storeconsultancy.php" method="POST" onsubmit="return validateForm()" name="myform">
<fieldset>
	<?php
...
function validateForm() {
    var x = document.forms["myform"]["worktitle"].value;
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Title of Work</label>  
  <div class="col-md-4">
  <input id="3" name="worktitle" type="text" placeholder="" pattern="[a-z]{1,20}" class="form-control input-md">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Client name and address</label>  
  <div class="col-md-4">
  <input id="1" name="address" type="text" placeholder="" pattern="[a-z]{1,50}" class="form-control input-md">
  </div>
</div>

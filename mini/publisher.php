...
<form class="form-horizontal" action="storepublisher.php" method="POST" onsubmit="return validateForm()" name="myform">
<fieldset>
	<?php
...
function validateForm() {
    var x = document.forms["myform"]["booktitle"].value;
    var y = document.forms["myform"]["publisher"].value;
    var z = document.forms["myform"]["publicationyear"].value;
   if (x == "0" ||y == "0" ||z == "0") {
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Title of book</label>  
  <div class="col-md-4">
  <input id="3" name="booktitle" type="text" placeholder="" pattern="[a-z]{1,20}" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="2" name="publicationyear" type="text" placeholder="" pattern="[0-9]{1,10}" class="form-control input-md">

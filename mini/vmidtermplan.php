...
<!-- Form Name -->
<legend>View midtermplan</legend>
...
if(isset($_POST['submit'])){
    if(!empty($_POST['faculty'])){
		...
		<table align="center" border=1>
			<tr>
				...
				<th align="center" width="150px">Mid number</th>
				<th align="center" width="150px">Exam Date</th>
				<th align="center" width="150px">Submission Date</th>	
			</tr>
				<?php
        ...
        foreach($_POST['faculty'] as $selected){
            ...
            if($selected=="all")
            {
				$sqlCustomer = "SELECT * FROM midterm";
    ...
    ?>
			...
			else
			{
					 ...
					 $sqlCustomer = "SELECT * FROM midterm where facultyname='$selected'";
				$aCustomer =mysql_query($sqlCustomer);
				?>

...
if(isset($_POST['submit'])){
    if(!empty($_POST['faculty'])){
		...
		<table align="center" border=1>
				<tr>
	                ...
	                <th align="center" width="150px">CounsellingSubject</th>
	                <th align="center" width="150px">Semister</th>
	                <th align="center" width="150px">Branch</th>
	                <th align="center" width="150px">Section</th>
	                <th align="center" width="150px">Dates of meetings</th>
	                <th align="center" width="150px">Students councelled</th>
				</tr>
				<?php
        ...
        foreach($_POST['faculty'] as $selected){
            ...
            if($selected=="all")
            {
				$sqlCustomer = "SELECT * FROM mentoring";
    ...
    ?>
			...
			else
			{
					 ...
					 $sqlCustomer = "SELECT * FROM mentoring where facultyname='$selected'";
				$aCustomer =mysql_query($sqlCustomer);
				?>

...
if(isset($_POST['submit'])){
    if(!empty($_POST['faculty'])){
        ...
        foreach($_POST['faculty'] as $selected){
            ...
            if($selected=="all")
            {
				$sqlCustomer = "SELECT * FROM feedback";
    ...
    ?>
			...
			else
			{
					 ...
					 $sqlCustomer = "SELECT * FROM feedback where facultyname='$selected'";
				$aCustomer =mysql_query($sqlCustomer);
				?>
...
$str="SELECT FacultyName,academicyear,subject,semister,branch,section,feedbackpercentage from  feedback";
$result=$conn->query($str);

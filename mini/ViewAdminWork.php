...
if(isset($_POST['submit'])){
    if(!empty($_POST['faculty'])){
		...
		<table align="center" border=1>
				...
				<th align="center" width="150px">Type of committee</th>
				<th align="center" width="150px">Role</th>
				</tr>
				<?php
        ...
        foreach($_POST['faculty'] as $selected){
            ...
            if($selected=="all")
            {
				$sqlCustomer = "SELECT * FROM adminwork";
			...
			else
			{
					 ...
					 $sqlCustomer = "SELECT * FROM adminwork where facultyname='$selected'";
				$aCustomer =mysql_query($sqlCustomer);
				?>
